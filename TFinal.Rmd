...
¿Qué es el Big Data?
  ...
  + *Dificultad* de **manejar** *datos grandes* con *métodos/herramientas tradicionales* (excel, spss, ...)
  
> Definición (Rstudio):
  
  - *Velocidad de respuesta*
  - Almacenamiento de la PC > TAMAÑO DATA > RAM (LOCAL); *4G* - 64G
  - TAMAÑO DATA > Almacenamiento de la PC (NUBE/INTERNET); 200G - 2T
...
4. Buscar ejemplos (al menos uno) de bases de datos, páginas web u otros asociados a datos que no respeten los principios de privacidad y confidencialidad.
